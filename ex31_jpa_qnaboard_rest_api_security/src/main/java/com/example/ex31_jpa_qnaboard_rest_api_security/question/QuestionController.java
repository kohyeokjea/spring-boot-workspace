...
public class QuestionController {
    ...
    public ResponseEntity<String> questionCreate(@Valid @RequestBody QuestionDTO questionDTO,
        ...
        try {
            ...
            return new ResponseEntity<>("Question created successfully", HttpStatus.CREATED); // 질문 저장후 질문목록으로 이동
        } catch (Exception e) {
            return new ResponseEntity<>("Failed create question", HttpStatus.INTERNAL_SERVER_ERROR); // 질문 저장후 질문목록으로 이동
        }
    }
